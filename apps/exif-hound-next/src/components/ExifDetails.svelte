<div class="exif-details flex h-auto w-[30%] bg-white">
    <ul>
        <li  class="text-black">
            <div id="exif-property" class="w-full flex justify-between p-3">
                <div id="exif-prop" class="w-auto font-bold self-center mr-2">
                    Image Data:
                </div>
                <div id="exif-value" class="w-auto font-light self-center mr-4">
                    Null
                </div>
