...
const ImageTray = (props) => {
        ...
        return imageArray.map((image, index) => {
            return (
                ...
                >
                    ...
                    >
                        <img src={image.ImageData} alt="" class="min-w-[200px] max-w-[400px] mb-4" />
                    </div>
    ...
    return (
        <div id="sidebar" className='min-w-[500px] p-5 bg-gray-900'>
            <div className="sidebar-button-bar mb-6">
...
export default observer(ImageTray);